...
class LightRAG:
    ...
    allow_legacy_query_cache_fallback: bool = field(
        default=get_env_value("ALLOW_LEGACY_QUERY_CACHE_FALLBACK", True, bool)
    )
    """If True, old query-only QA cache entries may be used and migrated."""

    skip_failed_llm_calls: bool = field(
        default=get_env_value("SKIP_FAILED_LLM_CALLS", False, bool)
    )
    """If True, timeout failures in long-running eval paths are recorded and skipped."""
